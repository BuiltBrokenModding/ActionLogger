...
{
    private final static String query = "INSERT INTO " + EventDatabase.BLOCK_PLACE_TABLE + " (time, dim, x, y, z, player, item, block, meta, tile, block_new, meta_new, placed_against)"
            + " values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
